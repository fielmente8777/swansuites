...
const AccommodationsCards: React.FC<AccommodationsProps["rooms"][0]> = ({
  ...
  return (
    <div className="group rounded-2xl overflow-hidden">
      <div className="w-full relative md:aspect-4/2 aspect-3/2.25">
        <div className="w-full relative ">
          ...
          <SwiperCarousel
            ...
            swiperSlideClassName="relative w-full aspect-[3/3] "
            renderSlide={(image) => (
      ...
      <div className="py-5 px-4 group-hover:bg-background shadow-2xl bg-[#FFF5E6] transition-all duration-300 ease-in-out flex flex-col gap-4">
