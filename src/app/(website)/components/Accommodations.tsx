...
const Accommodations: React.FC<AccommodationsProps> = ({
  ...
  return (
    <SectionWithContainer sectionClassName="bg-[#FFF5E6] border-y border-secondary">
      <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 items-center max-w-5xl mx-auto w-full lg:gap-15 gap-6">
        <div className="lg:col-span-1 md:col-span-2 col-span-1 space-y-2.5">
          ...
          <p className="text-lg text-light">{description}</p>
           <ul className="grid grid-cols-1 mt-7">
          {rooms[0].actions?.map((button, i) => (
            <li key={i}>
              <LinkButton
                {...button}
